...
import com.ffi.financial.service.CurrentAssetImpl;
...
public class AssetEndPoint {
	...
	@Autowired
	CurrentAssetImpl currentAssetImpl;

	@Autowired
	ConfigAppProperties configAppProperties;

	@GetMapping(value = "/getAsset/{assetId}", produces = "application/json")
	@ResponseBody
	public ResponseJson<Response> getLead(@PathVariable final String assetId) {
		ResponseJson<Response> pocResponseJson = new ResponseJson<Response>();
		try {
			Response response = new Response();
			Map<String, Object> responseObject = new HashMap<String, Object>();
			responseObject.put("asset", currentAssetImpl.getAsset(assetId));
